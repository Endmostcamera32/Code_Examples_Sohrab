...
export default function PostActions({ onComment, onLike, onShare, totalLikes, postDetail, totalComments, liked, className = "" }) {

  return (
    <div className={'flex items-center justify-between ' + className}>
      <button
        onClick={() => {onComment(postDetail)}}
