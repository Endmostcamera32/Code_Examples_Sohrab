  ...
  return (
    <div className={twMerge('lex flex-col overflow-hidden rounded-lg shadow-lg', className)}>
      ...
      <div className="flex flex-col items-center pb-3">
        <PostActions onComment={onComment} onLike={onLike} onShare={onShare} liked={post.liked} postDetail={post} totalComments={post.totalComments} totalLikes={post.totalLikes} />
      </div>
